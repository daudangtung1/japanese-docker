    ...
    <section class="pt-16 relative h-screen" style="max-height: 860px">
        <div class="container mx-auto items-center flex flex-wrap">
            <div class="w-full md:w-8/12 lg:w-6/12 xl:w-6/12 px-4">
                <div class="pt-32 sm:pt-0 lg:mt-20">
                    <h2 class="font-semibold text-4xl text-blue-600">A beautiful extension for TailwindCSS.</h2>
                    <p class="text-lg mt-4 leading-relaxed">Tailwind Starter Kit is Free and Open Source. It does not
                        change or add any CSS to the already one from TailwindCSS. It features multiple HTML elements
