                        ...
                        >
                          ...
                          />
                                ...
                                <div class="flex-1 overflow-hidden">
                                    ...
                                    <span
                                        class="text-sm font-normal text-gray-400 dark:text-primary-light"> 2d ago </span>
                                </div>
                            </div>
                        </a>
                      ...
                      <span class="relative z-10 inline-block overflow-visible rounded-ful">
                        ...
                        />
                                ...
                                <div class="flex-1 overflow-hidden">
                                    ...
                                    <span
                                        class="text-sm font-normal text-gray-400 dark:text-primary-light"> 1d ago </span>
                                </div>
                            </div>
                        </a>
                        <a href="#" class="block">
                      ...
                      <span class="relative z-10 inline-block overflow-visible rounded-ful">
                        ...
                        />
                                ...
                                <div class="flex-1 overflow-hidden">
                                    ...
                                    <span
                                        class="text-sm font-normal text-gray-400 dark:text-primary-light"> 10h ago </span>
                                </div>
                            </div>
                        </a>
                        <a href="#" class="block">
                ...
                <div class="flex-1 px-4 pb-4 space-y-4 overflow-y-hidden h hover:overflow-y-auto">
                    ...
                    <a href="#" class="flex space-x-4">
                        ...
                        <div class="flex-1 max-w-xs overflow-hidden">
                            ...
                            <span
                                class="text-sm font-normal text-gray-400 dark:text-primary-light"> Updated 3h ago. </span>
                        </div>
                    </a>
                    <template x-for="i in 10" x-key="i">
                        <a href="#" class="flex space-x-4">
